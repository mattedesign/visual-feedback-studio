-- Step 1: First update existing data to new format
...
-- Step 3: Update the subscription for sparkingmatt user to unlimited_admin
UPDATE public.user_subscriptions 
SET 
...
-- Step 5: Re-enable the constraint with new allowed values
ALTER TABLE public.user_subscriptions 
