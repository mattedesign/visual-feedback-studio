-- Create an unlimited super admin plan and assign it to sparkingmatt@gmail.com
-- First, add the unlimited plan type to the constraint
...
-- Update sparkingmatt@gmail.com to use the unlimited admin plan
...
BEGIN
  ...
  CASE user_plan
    ...
    WHEN 'unlimited_admin' THEN target_limit := 999999;
