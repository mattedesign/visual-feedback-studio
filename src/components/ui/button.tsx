...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "inline-flex py-2 px-5 justify-center items-center gap-2 rounded-xl bg-gradient-to-b from-[#323232] to-[#222] shadow-[0px_0.5px_1px_0px_rgba(255,255,255,0.15)_inset,0px_2px_4px_-1px_rgba(13,13,13,0.50),0px_-1px_1.2px_0.35px_#121212_inset,0px_0px_0px_1px_#333] text-[#FCFCFC] text-center font-['Instrument_Sans'] text-sm font-semibold leading-5 tracking-[-0.28px] hover:rounded-xl hover:bg-gradient-to-b hover:from-[#323232] hover:to-[#222] hover:shadow-[0px_0.5px_1px_0px_rgba(255,255,255,0.15)_inset,0px_2px_4px_-1px_rgba(13,13,13,0.50),0px_-1px_1.2px_0.35px_#121212_inset,0px_0px_0px_1px_#333] focus:rounded-xl focus:bg-gradient-to-b focus:from-[#222] focus:to-[#323232] focus:shadow-[0px_0.5px_1px_0px_rgba(255,255,255,0.15)_inset,0px_2px_4px_-1px_rgba(13,13,13,0.50),0px_-1px_1.2px_0.35px_#121212_inset,0px_0px_0px_1px_#333] active:rounded-xl active:bg-gradient-to-b active:from-[#222] active:to-[#323232] active:shadow-[0px_0.5px_1px_0px_rgba(255,255,255,0.15)_inset,0px_2px_4px_-1px_rgba(13,13,13,0.50),0px_-1px_1.2px_0.35px_#121212_inset,0px_0px_0px_1px_#333] transition-all duration-200",
        destructive:
