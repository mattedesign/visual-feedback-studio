  ...
  return <div className="shadow-lg">
      <div className="p-6 py-0">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <SimplifiedContextInput analysisContext={workflow.analysisContext} onAnalysisContextChange={workflow.setAnalysisContext} onAnalyze={handleAnalyze} canAnalyze={canAnalyze} isAnalyzing={workflow.isAnalyzing} uploadedImageCount={workflow.selectedImages.length} />

          {/* Helper text */}
          {!hasImages && <div className="text-center">
